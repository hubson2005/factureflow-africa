  ...
  return (
    <>
      ...
      <div style={{ position:'relative', zIndex:1, minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', padding:'40px 16px' }}>
        ...
        {profile.bio && (
          <p style={{ color:'rgba(255,255,255,0.8)',  fontWeight:'500', fontSize:'14px', textAlign:'center', maxWidth:'300px', marginBottom:'12px' }}>{profile.bio}</p>
        )}
        ...
        {images.map((_, i) => (
          ...
          />
            ...
            {countdown && (
              <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'8px', marginBottom:'12px' }}>
                {[{v:countdown.days,l:'Jours'},{v:countdown.hours,l:'Heures'},{v:countdown.mins,l:'Min'},{v:countdown.secs,l:'Sec'}].map(({v,l}) => (
                  <div key={l} style={{background: 'rgba(255, 255, 255, 0.51)', borderRadius: '12px', padding: '10px', textAlign: 'center', border: '1px solid rgba(255,255,255,0.25)' }}>
                    <div style={{ fontSize:'24px', fontWeight:'800', color:'#e74104', lineHeight:1 }}>{String(v).padStart(2,'0')}</div>
            ...
            {profile.event_description && (
              <div style={{ background: 'rgba(255, 255, 255, 0.51)', borderRadius: '16px', padding: '14px 16px', marginBottom: '12px', border: '1px solid rgba(255, 255, 255, 0.55)' }}>
                <p style={{ fontSize:'13px', color:'rgb(0, 0, 0)', lineHeight:'1.6', margin:0, whiteSpace:'pre-wrap' }}>{profile.event_description}</p>
              </div>
            )}
